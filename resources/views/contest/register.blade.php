        ...
        <div class="row">
            ...
            <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s4 m4 l4">
                            <input type="text" name="institute_name" id="institute-name" placeholder="Your highschool name" class="validate">
                            <label for="institute-name">Highschool name</label>
                        </div>
                    </div>
                    <!-- /Team Info -->
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s4 m3 l3">
                            <select name="members[first][degree]" id="mem1-degree">
                                <option value="first" disabled>First grade</option>
                                <option value="second" selected>Second grade</option>
