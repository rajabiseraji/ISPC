    ...
    <form name="onsite_register" class="col s12 m12 l12" action="{{ route('app::admin.registration.save', $team) }}" method="POST">
        <div id="non-skrollr">
            <div class="row">
                ...
                <h5>2nd Amirkabir Student Programming Contest - 18 Nov 2016</h5>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s4 m4 l4">
                            ...
                            <label for="institute-name">Highschool</label>
                        </div>
                    </div>
                    <!-- /Team Info -->
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s3 m3 l3">
                            <select name="members[first][degree]" id="mem1-degree">
                                ...
                                <option value="first" {{$team->members['first']['degree'] == 'first' ? 'selected' : ''}}>First degree</option>
                                <option value="second" {{$team->members['first']['degree'] == 'second' ? 'selected' : ''}}>Second Degree</option>
                                <option value="third" {{$team->members['first']['degree'] == 'third' ? 'selected' : ''}}>Third Degree</option>
                                <option value="fourth" {{$team->members['first']['degree'] == 'fourth' ? 'selected' : ''}}>Fourth Degree</option>
                            </select>
                        ...
                        <div class="input-field col s2 m2 l2">
                            <select name="members[first][t-shirt_size]" id="mem1-size">
                                ...
                                <option value="3X Large" {{$team->members['first']['t-shirt_size'] == '3X Large' ? 'selected' : ''}}>3X Large</option>
                                <option value="2X Large" {{$team->members['first']['t-shirt_size'] == '2X Large' ? 'selected' : ''}}>2X Large</option>
                                <option value="X Large" {{$team->members['first']['t-shirt_size'] == 'X Large' ? 'selected' : ''}}>X Large</option>
                                <option value="Large" {{$team->members['first']['t-shirt_size'] == 'Large' ? 'selected' : ''}}>Large</option>
                                <option value="Medium" {{$team->members['first']['t-shirt_size'] == 'Medium' ? 'selected' : ''}}>Medium</option>
                                <option value="Small" {{$team->members['first']['t-shirt_size'] == 'Small' ? 'selected' : ''}}>Small</option>
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s3 m3 l3">
                            <select name="members[second][degree]" id="mem2-degree">
                                <option value="" disabled>Current educational level</option>
                                <option value="first" {{$team->members['second']['degree'] == 'first' ? 'selected' : ''}}>First degree</option>
                                <option value="second" {{$team->members['second']['degree'] == 'second' ? 'selected' : ''}}>Second Degree</option>
                                <option value="third" {{$team->members['second']['degree'] == 'third' ? 'selected' : ''}}>Third Degree</option>
                                <option value="fourth" {{$team->members['second']['degree'] == 'fourth' ? 'selected' : ''}}>Fourth Degree</option>
                            </select>
                            <label>Current Educational Level</label>
                        </div>
                        <div class="input-field col s2 m2 l2">
                            <select name="members[second][t-shirt_size]" id="mem2-size">
                                <option value="" disabled selected>Select Size</option>
                                <option value="3X Large" {{$team->members['second']['t-shirt_size'] == '3X Large' ? 'selected' : ''}}>3X Large</option>
                                <option value="2X Large" {{$team->members['second']['t-shirt_size'] == '2X Large' ? 'selected' : ''}}>2X Large</option>
                                <option value="X Large" {{$team->members['second']['t-shirt_size'] == 'X Large' ? 'selected' : ''}}>X Large</option>
                                <option value="Large" {{$team->members['second']['t-shirt_size'] == 'Large' ? 'selected' : ''}}>Large</option>
                                <option value="Medium" {{$team->members['second']['t-shirt_size'] == 'Medium' ? 'selected' : ''}}>Medium</option>
                                <option value="Small" {{$team->members['second']['t-shirt_size'] == 'Small' ? 'selected' : ''}}>Small</option>
                            </select>
                            <label>T-Shirt Size</label>
                        </div>
                        <div class="input-field col s3 m3 l3">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s3 m3 l3">
                            <select name="members[third][degree]" id="mem3-degree">
                                <option value="" disabled>Current educational level</option>
                                <option value="first" {{$team->members['third']['degree'] == 'first' ? 'selected' : ''}}>First degree</option>
                                <option value="second" {{$team->members['third']['degree'] == 'second' ? 'selected' : ''}}>Second Degree</option>
                                <option value="third" {{$team->members['third']['degree'] == 'third' ? 'selected' : ''}}>Third Degree</option>
                                <option value="fourth" {{$team->members['third']['degree'] == 'fourth' ? 'selected' : ''}}>Fourth Degree</option>
                            </select>
                            <label>Current Educational Level</label>
                        </div>
                        <div class="input-field col s2 m2 l2">
                            <select name="members[third][t-shirt_size]" id="mem3-size">
                                <option value="" disabled selected>Select Size</option>
                                <option value="3X Large" {{$team->members['third']['t-shirt_size'] == '3X Large' ? 'selected' : ''}}>3X Large</option>
                                <option value="2X Large" {{$team->members['third']['t-shirt_size'] == '2X Large' ? 'selected' : ''}}>2X Large</option>
                                <option value="X Large" {{$team->members['third']['t-shirt_size'] == 'X Large' ? 'selected' : ''}}>X Large</option>
                                <option value="Large" {{$team->members['third']['t-shirt_size'] == 'Large' ? 'selected' : ''}}>Large</option>
                                <option value="Medium" {{$team->members['third']['t-shirt_size'] == 'Medium' ? 'selected' : ''}}>Medium</option>
                                <option value="Small" {{$team->members['third']['t-shirt_size'] == 'Small' ? 'selected' : ''}}>Small</option>
                            </select>
                            <label>T-Shirt Size</label>
                        </div>
                        <div class="input-field col s3 m3 l3">
